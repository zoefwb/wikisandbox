...
<br> Date: December 14, 2021

### Background

As FWB grows from URL into IRL, we need a cohesive language around programming. Inspired by the seminal 70s text, [The Timeless Way of Building](https://en.wikipedia.org/wiki/The_Timeless_Way_of_Building), our goal is to build an Events Pattern Language to guide the Cities’ team on how to create a global programming strategy, that is connected in values and individualized by a local filter. 

To successfully deploy FWB Event Patterns, one must read and incorporate the values of our [Manifesto](https://github.com/friends-with-benefits/fwb-wiki/blob/main/pages/manifesto.mdx) and [Code of Conduct](https://github.com/friends-with-benefits/fwb-wiki/blob/main/pages/code-of-conduct.mdx). These are the backbone of our community and we must adhere to them at all times. 
...
- Good [people](https://github.com/friends-with-benefits/fwb-wiki/blob/main/pages/manifesto.mdx). 
- Good [music](https://medium.com/@ColtonDewberry/what-makes-good-music-good-f27e9e4b6e9c). 
- Good location. 
...
Therefore all venues for programming must be welcoming of a diverse audience and share FWB values as laid out in our [manifesto](https://github.com/friends-with-benefits/fwb-wiki/blob/main/pages/manifesto.mdx). 
...
- Music focused nights must be in venues that have a [great](https://mixmag.net/feature/10-audiophile-friendly-venues-you-need-to-visit) sound [system](https://blog.landr.com/8-best-club-sound-systems-time/). This is non-negotiable. 
...
- Provide non-wallet [solutions](https://www.getpartiful.com/) for RSVP.  
...
![CarryNation](https://github.com/zoefwb/wikisandbox/blob/main/CodeofCarry.png)
![Merce](https://github.com/zoefwb/wikisandbox/blob/main/MerceCunningham.png)

The KLF - [The Manual (How to have a Number One Hit the Easy Way)](https://ia801007.us.archive.org/0/items/TheManualHowToHaveANumber1TheEasyWay/KLF%20-%20%20The%20Manual%20-%20How%20To%20Have%20A%20Number%201%20The%20Easy%20Way.pdf)
<br> Bruce Mau - [An Incomplete Manifesto for Growth](https://brucemaustudio.com/projects/an-incomplete-manifesto-for-growth/)
