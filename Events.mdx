...
[DJ Event](Events.mdx#dj-event)

[Grand Dining](Events.mdx#grand-dining)

[Digital Events](Events.mdx#digital-events)

[Thriftmas Event](Events.mdx#thriftmas-event)

[Art Crawl](Events.mdx#art-crawl)

[Coworking](Events.mdx#coworking)

[Dining](Events.mdx#dining)

[Diversity](Events.mdx#diversity)

[Happy Hour](Events.mdx#happy-hour)

[Movie Night](Events.mdx#movie-night)

[Satellite Event at a Conference](Events.mdx#satellite-event-at-a-conference)

[Sourcing Talent](Events.mdx#sourcing-talent-from-your-discord-community)
...
For references and further information, be sure to review [FWB’s Event Pattern Language doc](PatternLanguage.mdx) (aka our all-purpose manual for vibe-building), and our [Dining SOP](Events.mdx#dining) (which includes a treasure trove of tips for hosting an incredible and seamlessly executed dinner).
...
After the gallery tours we opened a tab at a local bar in order for members to meet, chat and share their experiences during the day. Though members had a chance to chat on the walks to and from the galleries it was clear that a casual hang after the tour was a welcome opportunity to get to know each other further. (See [Happy Hour SOP](Events.mdx#happy-hour) for best practices on casual social drinks).
...
<br> <br> ![IndexEvent Map](IndexEventMap.png)
...
For an Ideal Timeline - [Check DJ Event SOP](Events.mdx#dj-event)
