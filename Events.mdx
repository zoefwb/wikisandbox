...
[Sourcing Talent](https://github.com/zoefwb/wikisandbox/blob/main/Events.mdx#sourcing-talent)
...
- Create the event invitation using the Figma templates provided ([LINK]())
- Load your event and details to the Gatekeeper app ([LINK]()) un: FWB PW: birds
- Have your Operations counterpart proof the work
- Test drive the platform and run through the process
...
[FEMALE FOUNDERS GROUPS](https://www.alma-angels.com/) // [LGBTQ+ CULTURAL MOVEMENTS]()
...
For specifics on promoting via Discord, TLDR newsletter, and FWB Socials please refer to the [Events Marketing Best Practices SOP]().
...
### Sourcing Talent From Your Discord Community: (DJ Night example)
